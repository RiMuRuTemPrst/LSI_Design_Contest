...
`define AUTOTB_DUT      adder32
`define AUTOTB_DUT_INST AESL_inst_adder32
`define AUTOTB_TOP      apatb_adder32_top
`define AUTOTB_LAT_RESULT_FILE "adder32.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "adder32.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_adder32_top
...
`define AUTOTB_TVIN_a  "../tv/cdatafile/c.adder32.autotvin_a.dat"
`define AUTOTB_TVIN_b  "../tv/cdatafile/c.adder32.autotvin_b.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.adder32.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.adder32.autotvin_b.dat"
`define AUTOTB_TVOUT_sum  "../tv/cdatafile/c.adder32.autotvout_sum.dat"
`define AUTOTB_TVOUT_sum_out_wrapc  "../tv/rtldatafile/rtl.adder32.autotvout_sum.dat"
module `AUTOTB_TOP;
...
reg dump_tvout_finish_sum;

initial begin : dump_tvout_runtime_sign_sum
    integer fp;
    dump_tvout_finish_sum = 0;
    ...
    fp = $fopen(`AUTOTB_TVOUT_sum_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_sum_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
