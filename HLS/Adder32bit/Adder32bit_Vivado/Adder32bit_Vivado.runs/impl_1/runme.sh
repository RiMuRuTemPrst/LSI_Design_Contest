...
HD_PWD='/home/rimurutempest/Code/LSI_Design_Contest/HLS/Adder32bit/Adder32bit_Vivado/Adder32bit_Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder32bit_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder32bit_BD_wrapper.tcl -notrace
