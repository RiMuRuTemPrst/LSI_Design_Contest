...
//Date        : Sun Jan 11 17:26:23 2026
//Host        : RimuruLenovo running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target Adder32bit_BD.bd
//Design      : Adder32bit_BD
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Adder32bit_BD,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Adder32bit_BD,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "Adder32bit_BD.hwdef" *) 
module Adder32bit_BD
   ();
  ...
  Adder32bit_BD_adder32_0_0 adder32_0
  ...
  Adder32bit_BD_axi_smc_0 axi_smc
  ...
  Adder32bit_BD_rst_ps8_0_100M_0 rst_ps8_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  Adder32bit_BD_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
