...
void conv_block_i(TensorMem<_Float16>& input, TensorMem<_Float16>& output,
                  ...
                  TensorMem<_Float16>& gamma, TensorMem<_Float16>& beta,
                  _Float16 epsilon) {
  Conv_Attributes conv_att(1, 1, 1, 3, 3, 1, 0, 0, 1, 2, 2);

  Conv_CNorm_RPad_reflect<_Float16, 3, C_IN, 0>(conv_att, input, weight, bias,
                                                output);
  Channel_Norm<_Float16>(output, output, gamma, beta, epsilon, {0, 0, 0, 0},
                         output.shape);
  Relu(output, output);
}

void conv_block_init(TensorMem<_Float16>& input, TensorMem<_Float16>& output,
                     TensorMem<_Float16>& gamma_0, TensorMem<_Float16>& beta_0,
                     _Float16 epsilon_0, TensorMem<_Float16>& weight,
                     TensorMem<_Float16>& bias, TensorMem<_Float16>& gamma_3,
                     TensorMem<_Float16>& beta_3, _Float16 epsilon_3) {
  // conv_block_init_0
  _Float16* Add_1_output_0_data =
      ARENA_1.alloc<_Float16>(BATCH_SIZE * 16 * 16 * 220);
  TensorMem<_Float16> Add_1_output_0(Add_1_output_0_data, input.shape, false);

  Channel_Norm<_Float16>(input, Add_1_output_0, gamma_0, beta_0, epsilon_0,
                         {0, 0, 0, 0}, input.shape);

  Conv_Attributes conv_att(1, 1, 1, 3, 3, 1, 1, 1, 1, 1, 1);

  Shape Conv_output_0_shape(BATCH_SIZE, 16, 16, 960);
  _Float16* Conv_output_0_data =
      ARENA_1.alloc<_Float16>(BATCH_SIZE * 16 * 16 * 960);
  TensorMem<_Float16> Conv_output_0(Conv_output_0_data, Conv_output_0_shape,
                                    false);

  Conv_CNorm_RPad_reflect<_Float16, 3, 220, 0>(conv_att, Add_1_output_0, weight,
                                               bias, Conv_output_0);

  // conv_block_init_3
  Channel_Norm<_Float16>(Conv_output_0, output, gamma_3, beta_3, epsilon_3,
                         {0, 0, 0, 0}, output.shape);
...
void upconv_block_i(TensorMem<_Float16>& input, TensorMem<_Float16>& output,
  ...
  _Float16* cvt_data =
      ARENA_1.alloc<_Float16>(BATCH_SIZE * X_SIZE * X_SIZE * C_IN * 2);
  TensorMem<_Float16> cvt(cvt_data, shape, false);

  ConvTranspose(convt_att, &input, &weight, &bias, &cvt);
  Channel_Norm<_Float16>(cvt, output, gamma, beta, epsilon, {0, 0, 0, 0},
                         shape);
...
void Hific(TensorMem<_Float16>& input, TensorMem<_Float16>& output) {
  ...
  _Float16* enc_output_data =
      ARENA_2.alloc<_Float16>(BATCH_SIZE * 16 * 16 * 220);
  ...
  Encoder_Conv_block_1:;
    ...
    _Float16* conv_1_output_data =
        ARENA_2.alloc<_Float16>(BATCH_SIZE * 256 * 256 * 60);
    TensorMem<_Float16> conv_1_output(conv_1_output_data, conv_1_output_shape,
                                      false);
    ...
    Conv_CNorm_RPad_reflect<_Float16, 7, 3, 0>(conv_1_att, input, weight_1,
                                               bias_1, conv_1_output);
    ARENA_1.pop();  // bias_1_data
    ARENA_1.pop();  // weight_1_data
    // ARENA_1.pop();  // Pad_output_0_data

    _Float16* norm_1_output_data =
        ARENA_1.alloc<_Float16>(BATCH_SIZE * 256 * 256 * 60);
    TensorMem<_Float16> norm_1_output(norm_1_output_data, conv_1_output_shape,
                                      false);

    Channel_Norm(conv_1_output, norm_1_output, gamma_1, beta_1, e, {0, 0, 0, 0},
                 conv_1_output_shape);
  ...
  Encoder_Conv_block_2:;
    ...
    _Float16* norm_2_output_data =
        ARENA_2.alloc<_Float16>(BATCH_SIZE * 128 * 128 * 120);
    TensorMem<_Float16> norm_2_output(norm_2_output_data, norm_2_output_shape,
                                      false);
    ...
    conv_block_i<60, 256, 256>(norm_1_output, norm_2_output, weight_2, bias_2,
                               gamma_2, beta_2, e);
  ...
  Encoder_Conv_block_3:;
    ...
    _Float16* norm_3_output_data =
        ARENA_1.alloc<_Float16>(BATCH_SIZE * 64 * 64 * 240);
    TensorMem<_Float16> norm_3_output(norm_3_output_data, norm_3_output_shape,
                                      false);
    ...
    conv_block_i<120, 128, 128>(norm_2_output, norm_3_output, weight_3, bias_3,
                                gamma_3, beta_3, e);
  ...
  Encoder_Conv_block_4:;
    ...
    _Float16* norm_4_output_data =
        ARENA_2.alloc<_Float16>(BATCH_SIZE * 32 * 32 * 480);
    TensorMem<_Float16> norm_4_output(norm_4_output_data, norm_4_output_shape,
                                      false);
    ...
    conv_block_i<240, 64, 64>(norm_3_output, norm_4_output, weight_4, bias_4,
                              gamma_4, beta_4, e);
  ...
  Encoder_Conv_block_5:;
    ...
    _Float16* norm_5_output_data =
        ARENA_1.alloc<_Float16>(BATCH_SIZE * 16 * 16 * 960);
    TensorMem<_Float16> norm_5_output(norm_5_output_data, norm_5_output_shape,
                                      false);
    ...
    conv_block_i<480, 32, 32>(norm_4_output, norm_5_output, weight_5, bias_5,
                              gamma_5, beta_5, e);
  ...
  Encoder_Conv_block_out:;
    ...
    Conv_CNorm_RPad_reflect<_Float16, 3, 16, 0>(conv_2_att, norm_5_output,
                                                weight_o, bias_o, enc_output);
  ...
  Hyperprior_Conv_block_1:;
    ...
    _Float16* conv_1_output_data =
        ARENA_2.alloc<_Float16>(BATCH_SIZE * 16 * 16 * 320);
    TensorMem<_Float16> conv_1_output(conv_1_output_data, conv_1_output_shape,
                                      false);
  ...
  Hyperprior_Conv_block_2:;
    ...
    _Float16* conv_2_output_data =
        ARENA_1.alloc<_Float16>(BATCH_SIZE * 8 * 8 * 320);
    TensorMem<_Float16> conv_2_output(conv_2_output_data, conv_2_output_shape,
                                      false);
    ...
    Conv_CNorm_RPad_reflect<_Float16, 5, 16, 0>(
        conv_2_att, conv_1_output, weight_2, bias_2, conv_2_output);
  ...
  Hyperprior_Conv_block_3:;
    ...
    _Float16* conv_3_output_data =
        ARENA_2.alloc<_Float16>(BATCH_SIZE * 4 * 4 * 320);
    TensorMem<_Float16> conv_3_output(conv_3_output_data, conv_3_output_shape,
                                      false);
    ...
    Conv_CNorm_RPad_reflect<_Float16, 5, 16, 0>(
        conv_2_att, conv_2_output, weight_3, bias_3, conv_3_output);
  ...
  Hyperprior_ConvTrans_block_1:;
    ...
    _Float16* conv_4_output_data =
        ARENA_1.alloc<_Float16>(BATCH_SIZE * 8 * 8 * 320);
    TensorMem<_Float16> conv_4_output(conv_4_output_data, conv_4_output_shape,
                                      false);
    ...
    ConvTranspose(conv_4_att, &conv_3_output, &weight_4, &bias_4,
                  &conv_4_output);
  ...
  Hyperprior_ConvTrans_block_2:;
    ...
    _Float16* conv_5_output_data =
        ARENA_2.alloc<_Float16>(BATCH_SIZE * 16 * 16 * 320);
    TensorMem<_Float16> conv_5_output(conv_5_output_data, conv_5_output_shape,
                                      false);

    read_tensor("model_params_2/Hyp_sm_c2_weight.txt", weight_5);
    read_tensor("model_params_2/Hyp_sm_c2_bias.txt", bias_5);

    ConvTranspose(conv_4_att, &conv_4_output, &weight_5, &bias_5,
                  &conv_5_output);
  ...
  Hyperprior_ConvTrans_block_3:;
    ...
    _Float16* conv_6_output_data =
        ARENA_1.alloc<_Float16>(BATCH_SIZE * 16 * 16 * 220);
    TensorMem<_Float16> conv_6_output(conv_6_output_data, conv_6_output_shape,
                                      false);
    ...
    ConvTranspose(conv_6_att, &conv_5_output, &weight_6, &bias_6,
                  &conv_6_output);
  ...
  Generator_Conv_block_init:;
    ...
    conv_block_init(enc_output, flip, cbi_gamma_0, cbi_beta_0, e, cbi_weight,
                    cbi_bias, cbi_gamma_3, cbi_beta_3, e);
  ...
  Generator_Res_block_0_8:;
    ...
    for (int i = 0; i < 9; i++) {
      rb_gamma_1_file[19] = rb_beta_1_file[19] = rb_gamma_2_file[19] =
          rb_beta_2_file[19] = rb_weight_1_file[19] = rb_bias_1_file[19] =
              rb_weight_2_file[19] = rb_bias_2_file[19] = i + 48;
      Identity(flep, flap);
      ...
      Resblock___Pad_ref_Conv_11133111111_CNorm_Relu___<16, 960, 960,
                                                        BATCH_SIZE>(
          flap, rb_weight_1, rb_bias_1, rb_gamma_1, rb_beta_1, rb_weight_2,
          rb_bias_2, rb_gamma_2, rb_beta_2, e, flep);
    }
    Add(flep, flip, flip);
  ...
  Generator_upconv_block_1_4:;
    ...
    _Float16* upconv_block_1_data =
        ARENA_2.alloc<_Float16>(BATCH_SIZE * 32 * 32 * 480);
    TensorMem<_Float16> upconv_block_1(upconv_block_1_data,
                                       upconv_block_1_shape, false);
    ...
    upconv_block_i<960, 16>(flip, upconv_block_1, ub_weight_1, ub_bias_1,
                            ub_gamma_1, ub_beta_1, e);
    ...
    _Float16* upconv_block_2_data =
        ARENA_1.alloc<_Float16>(BATCH_SIZE * 64 * 64 * 240);
    TensorMem<_Float16> upconv_block_2(upconv_block_2_data,
                                       upconv_block_2_shape, false);
    ...
    upconv_block_i<480, 32>(upconv_block_1, upconv_block_2, ub_weight_2,
                            ub_bias_2, ub_gamma_2, ub_beta_2, e);
    ...
    _Float16* upconv_block_3_data =
        ARENA_2.alloc<_Float16>(BATCH_SIZE * 128 * 128 * 120);
    TensorMem<_Float16> upconv_block_3(upconv_block_3_data,
                                       upconv_block_3_shape, false);
    ...
    upconv_block_i<240, 64>(upconv_block_2, upconv_block_3, ub_weight_3,
                            ub_bias_3, ub_gamma_3, ub_beta_3, e);
    ARENA_2.pop();  // free(beta_3_data)
    ARENA_2.pop();  // free(gamma_3_data)
    ...
    _Float16* upconv_block_4_data =
        ARENA_1.alloc<_Float16>(BATCH_SIZE * 256 * 256 * 60);
    TensorMem<_Float16> upconv_block_4(upconv_block_4_data,
                                       upconv_block_4_shape, false);
    ...
    upconv_block_i<120, 128>(upconv_block_3, upconv_block_4, ub_weight_4,
                             ub_bias_4, ub_gamma_4, ub_beta_4, e);
  ...
  Generator_Conv_block_out:;
    ...
    Conv_CNorm_RPad_reflect<_Float16, 7, 60, 0>(att, upconv_block_4, cbo_weight,
                                                cbo_bias, flyp);
