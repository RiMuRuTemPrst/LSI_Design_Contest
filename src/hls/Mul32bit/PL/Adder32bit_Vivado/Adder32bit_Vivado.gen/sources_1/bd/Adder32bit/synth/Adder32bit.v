...
//Date        : Wed Jan 14 18:18:57 2026
//Host        : RimuruLenovo running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target Adder32bit.bd
//Design      : Adder32bit
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Adder32bit,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Adder32bit,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "Adder32bit.hwdef" *) 
module Adder32bit
   ();
  ...
  Adder32bit_mul32_hls_0_0 mul32_hls_0
  ...
  Adder32bit_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  Adder32bit_smartconnect_0_1 smartconnect_0
  ...
  Adder32bit_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
