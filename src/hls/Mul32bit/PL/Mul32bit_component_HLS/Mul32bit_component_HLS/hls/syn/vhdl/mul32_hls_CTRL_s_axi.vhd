...
entity mul32_hls_CTRL_s_axi is
generic (
...
end entity mul32_hls_CTRL_s_axi;
...
architecture behave of mul32_hls_CTRL_s_axi is
    ...
    constant ADDR_P_DATA_0 : INTEGER := 16#20#;
    constant ADDR_P_DATA_1 : INTEGER := 16#24#;
    constant ADDR_P_CTRL   : INTEGER := 16#28#;
