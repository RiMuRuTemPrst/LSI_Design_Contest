...
entity resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_19 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_19 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln21_3_fu_149_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ap_sig_allocacmp_i_8 : STD_LOGIC_VECTOR (13 downto 0);
...
begin
    ...
    add_ln19_fu_118_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_8) + unsigned(ap_const_lv14_1));
    ...
    ap_sig_allocacmp_i_8_assign_proc : process(ap_CS_fsm_pp0_stage0, i_fu_62, ap_loop_init, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_8 <= ap_const_lv14_0;
        else 
    ...
    icmp_ln19_fu_112_p2 <= "1" when (ap_sig_allocacmp_i_8 = ap_const_lv14_3C00) else "0";
    ...
    skip_buffer_address1 <= zext_ln21_3_fu_149_p1(18 - 1 downto 0);
    ...
    zext_ln19_fu_124_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_8),18));
    zext_ln21_3_fu_149_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln21_reg_169_pp0_iter1_reg),64));
end behav;
