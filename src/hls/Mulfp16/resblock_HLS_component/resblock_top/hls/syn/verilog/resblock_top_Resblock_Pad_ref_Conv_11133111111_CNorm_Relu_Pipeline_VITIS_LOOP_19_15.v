...
module resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_15 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] gmem5_addr_read_reg_140;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_gmem5_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_pp0_stage0_11001_grp0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((m_axi_gmem5_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_gmem5_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign bitcast_ln21_fu_115_p1 = gmem5_addr_read_reg_140;
...
endmodule //resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_15
