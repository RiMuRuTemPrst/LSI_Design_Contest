...
module resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_177 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [17:0] empty;
output  [17:0] skip_buffer_address1;
output   skip_buffer_ce1;
output   skip_buffer_we1;
output  [15:0] skip_buffer_d1;
...
wire   [17:0] add_ln21_fu_128_p2;
reg   [17:0] add_ln21_reg_169;
reg   [17:0] add_ln21_reg_169_pp0_iter1_reg;
reg   [15:0] gmem0_addr_read_reg_174;
wire   [63:0] zext_ln21_fu_149_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [13:0] i_fu_62;
wire   [13:0] add_ln19_fu_118_p2;
wire    ap_loop_init;
reg   [13:0] ap_sig_allocacmp_i_18;
wire    ap_block_pp0_stage0;
reg    skip_buffer_we1_local;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
wire   [15:0] bitcast_ln21_fu_145_p1;
reg    skip_buffer_ce1_local;
wire   [17:0] zext_ln19_fu_124_p1;
reg    ap_done_reg;
...
always @ (*) begin
    if (((icmp_ln19_fu_112_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        skip_buffer_ce1_local = 1'b1;
    end else begin
        skip_buffer_ce1_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        skip_buffer_we1_local = 1'b1;
    end else begin
        skip_buffer_we1_local = 1'b0;
    end
end
...
assign add_ln19_fu_118_p2 = (ap_sig_allocacmp_i_18 + 14'd1);

assign add_ln21_fu_128_p2 = (zext_ln19_fu_124_p1 + empty);
...
assign bitcast_ln21_fu_145_p1 = gmem0_addr_read_reg_174;

assign icmp_ln19_fu_112_p2 = ((ap_sig_allocacmp_i_18 == 14'd15360) ? 1'b1 : 1'b0);
...
assign skip_buffer_address1 = zext_ln21_fu_149_p1;

assign skip_buffer_ce1 = skip_buffer_ce1_local;

assign skip_buffer_d1 = bitcast_ln21_fu_145_p1;

assign skip_buffer_we1 = skip_buffer_we1_local;

assign zext_ln19_fu_124_p1 = ap_sig_allocacmp_i_18;

assign zext_ln21_fu_149_p1 = add_ln21_reg_169_pp0_iter1_reg;

endmodule //resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_177
