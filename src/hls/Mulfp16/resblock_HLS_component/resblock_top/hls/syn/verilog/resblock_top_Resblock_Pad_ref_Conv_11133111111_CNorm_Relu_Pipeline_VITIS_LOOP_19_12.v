...
module resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_12 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [62:0] p_cast28_cast;
output  [9:0] b_buffer_address0;
output   b_buffer_ce0;
output   b_buffer_we0;
output  [15:0] b_buffer_d0;
...
reg   [15:0] gmem4_addr_read_reg_140;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        b_buffer_ce0_local = 1'b1;
    end else begin
        b_buffer_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        b_buffer_we0_local = 1'b1;
    end else begin
        b_buffer_we0_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_gmem4_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_pp0_stage0_11001_grp0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((m_axi_gmem4_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_gmem4_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign b_buffer_address0 = zext_ln19_fu_111_p1;

assign b_buffer_ce0 = b_buffer_ce0_local;

assign b_buffer_d0 = bitcast_ln21_fu_115_p1;

assign b_buffer_we0 = b_buffer_we0_local;

assign bitcast_ln21_fu_115_p1 = gmem4_addr_read_reg_140;
...
endmodule //resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_12
