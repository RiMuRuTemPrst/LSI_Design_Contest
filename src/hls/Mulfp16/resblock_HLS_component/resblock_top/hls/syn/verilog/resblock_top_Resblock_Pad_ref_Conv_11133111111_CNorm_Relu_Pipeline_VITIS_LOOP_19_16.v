...
module resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_16 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [9:0] m_axi_gmem7_0_RFIFONUM;
...
input  [62:0] p_cast27_cast;
output  [9:0] gamma_buffer_address0;
output   gamma_buffer_ce0;
output   gamma_buffer_we0;
output  [15:0] gamma_buffer_d0;
...
reg   [15:0] gmem7_addr_read_reg_140;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        gamma_buffer_we0_local = 1'b1;
    end else begin
        gamma_buffer_we0_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_gmem7_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_pp0_stage0_11001_grp0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((m_axi_gmem7_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_gmem7_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign bitcast_ln21_fu_115_p1 = gmem7_addr_read_reg_140;

assign gamma_buffer_address0 = zext_ln19_fu_111_p1;

assign gamma_buffer_ce0 = gamma_buffer_ce0_local;

assign gamma_buffer_d0 = bitcast_ln21_fu_115_p1;

assign gamma_buffer_we0 = gamma_buffer_we0_local;

assign icmp_ln19_fu_88_p2 = ((ap_sig_allocacmp_i == 10'd960) ? 1'b1 : 1'b0);

assign m_axi_gmem7_0_ARADDR = 64'd0;
...
endmodule //resblock_top_Resblock_Pad_ref_Conv_11133111111_CNorm_Relu_Pipeline_VITIS_LOOP_19_16
