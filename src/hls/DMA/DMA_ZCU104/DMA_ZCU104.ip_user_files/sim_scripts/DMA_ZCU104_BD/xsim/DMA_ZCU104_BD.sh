...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L axi_bram_ctrl_v4_1_11 -L blk_mem_gen_v8_4_9 -L lib_pkg_v1_0_4 -L lib_srl_fifo_v1_0_4 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_35 -L axi_sg_v4_1_19 -L axi_cdma_v4_1_33 -L xlconstant_v1_1_9 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DMA_ZCU104_BD xil_defaultlib.DMA_ZCU104_BD xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DMA_ZCU104_BD -key {Behavioral:sim_1:Functional:DMA_ZCU104_BD} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b811.protoinst" -protoinst "protoinst_files/DMA_ZCU104_BD.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/rimurutempest/Tool/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DMA_ZCU104_BD.wdb xsim.dir libdpi.so)
