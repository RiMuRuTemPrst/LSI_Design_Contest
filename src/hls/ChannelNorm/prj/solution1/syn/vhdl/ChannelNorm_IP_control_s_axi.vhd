...
entity ChannelNorm_IP_control_s_axi is
generic (
...
end entity ChannelNorm_IP_control_s_axi;
...
architecture behave of ChannelNorm_IP_control_s_axi is
    ...
    constant ADDR_EPSILON_DATA_0 : INTEGER := 16#34#;
    constant ADDR_EPSILON_CTRL   : INTEGER := 16#38#;
    constant ADDR_Y_DATA_0       : INTEGER := 16#3c#;
    constant ADDR_Y_DATA_1       : INTEGER := 16#40#;
