...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconstant_v1_1_9 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L axi_vip_v1_1_19 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Adder32bit_sim xil_defaultlib.Adder32bit_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Adder32bit_sim -key {Behavioral:sim_1:Functional:Adder32bit_sim} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ea77.protoinst" -protoinst "protoinst_files/Adder32bit_BD.protoinst" -protoinst "protoinst_files/bd_7461.protoinst" -protoinst "protoinst_files/Adder32bit_sim.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Adder32bit_sim.wdb xsim.dir libdpi.so)
