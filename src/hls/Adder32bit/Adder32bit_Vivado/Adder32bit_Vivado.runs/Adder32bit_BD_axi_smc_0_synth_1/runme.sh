...
HD_PWD='/home/rimurutempest/Code/LSI_Design_Contest/HLS/Adder32bit/Adder32bit_Vivado/Adder32bit_Vivado.runs/Adder32bit_BD_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder32bit_BD_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder32bit_BD_axi_smc_0.tcl
