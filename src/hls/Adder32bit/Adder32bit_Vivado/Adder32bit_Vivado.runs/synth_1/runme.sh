...
HD_PWD='/home/rimurutempest/Code/LSI_Design_Contest/HLS/Adder32bit/Adder32bit_Vivado/Adder32bit_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder32bit_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder32bit_BD_wrapper.tcl
