...
entity upconv_core_top_control_s_axi is
generic (
...
end entity upconv_core_top_control_s_axi;
...
-- 0x54 : reserved
-- 0x58 : Data signal of epsilon
--        bit 15~0 - epsilon[15:0] (Read/Write)
--        others   - reserved
-- 0x5c : reserved
-- 0x60 : Data signal of mode
--        bit 31~0 - mode[31:0] (Read/Write)
-- 0x64 : reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of upconv_core_top_control_s_axi is
    ...
    constant ADDR_EPSILON_DATA_0 : INTEGER := 16#58#;
    constant ADDR_EPSILON_CTRL   : INTEGER := 16#5c#;
    constant ADDR_MODE_DATA_0    : INTEGER := 16#60#;
    constant ADDR_MODE_CTRL      : INTEGER := 16#64#;
