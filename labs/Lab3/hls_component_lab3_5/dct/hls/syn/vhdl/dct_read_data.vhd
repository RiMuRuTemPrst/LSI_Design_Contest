...
attribute shreg_extract : string;
    ...
    signal icmp_ln89_fu_291_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln86_fu_249_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln86_reg_365 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal trunc_ln91_fu_269_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal trunc_ln91_reg_380 : STD_LOGIC_VECTOR (2 downto 0);
    signal trunc_ln91_reg_380_pp0_iter1_reg : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln91_fu_285_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln91_reg_384 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln89_reg_389 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_phi_mux_icmp_ln915_phi_fu_212_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln92_fu_328_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln89_fu_333_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal indvar_flatten2_fu_72 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal add_ln89_1_fu_273_p2 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal add_ln89_fu_243_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_3_fu_312_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln91_fu_319_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln92_fu_322_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_141)) then
                indvar_flatten2_fu_72 <= add_ln89_1_fu_273_p2;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln89_reg_389 <= icmp_ln89_fu_291_p2;
                r_reg_370 <= r_fu_257_p3;
                r_reg_370_pp0_iter1_reg <= r_reg_370;
                select_ln86_reg_365 <= select_ln86_fu_249_p3;
                trunc_ln91_reg_380 <= trunc_ln91_fu_269_p1;
                trunc_ln91_reg_380_pp0_iter1_reg <= trunc_ln91_reg_380;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln91_reg_384 <= icmp_ln91_fu_285_p2;
            end if;
        end if;
    end process;
    ...
    add_ln89_1_fu_273_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten2_load) + unsigned(ap_const_lv6_1));
    add_ln89_fu_243_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_r3_load) + unsigned(ap_const_lv4_1));
    add_ln92_fu_322_p2 <= std_logic_vector(unsigned(tmp_3_fu_312_p3) + unsigned(zext_ln91_fu_319_p1));
    ...
    ap_condition_369_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln89_reg_389, ap_block_pp0_stage0)
    begin
                ap_condition_369 <= ((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln89_reg_389 = ap_const_lv1_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln89_fu_291_p2, ap_start_int)
    begin
        if (((icmp_ln89_fu_291_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_phi_mux_icmp_ln915_phi_fu_212_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln91_reg_384, ap_loop_init, ap_condition_369)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) then
            if ((ap_const_boolean_1 = ap_condition_369)) then 
                ap_phi_mux_icmp_ln915_phi_fu_212_p4 <= icmp_ln91_reg_384;
            elsif ((ap_loop_init = ap_const_logic_1)) then 
                ap_phi_mux_icmp_ln915_phi_fu_212_p4 <= ap_const_lv1_0;
            else 
                ap_phi_mux_icmp_ln915_phi_fu_212_p4 <= icmp_ln91_reg_384;
            end if;
        else 
    ...
    buf_0_address0 <= zext_ln89_fu_333_p1(3 - 1 downto 0);
    ...
    buf_0_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln91_reg_380_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln91_reg_380_pp0_iter1_reg = ap_const_lv3_0))) then 
    ...
    buf_1_address0 <= zext_ln89_fu_333_p1(3 - 1 downto 0);
    ...
    buf_1_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln91_reg_380_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln91_reg_380_pp0_iter1_reg = ap_const_lv3_1))) then 
    ...
    buf_2_address0 <= zext_ln89_fu_333_p1(3 - 1 downto 0);
    ...
    buf_2_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln91_reg_380_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln91_reg_380_pp0_iter1_reg = ap_const_lv3_2))) then 
    ...
    buf_3_address0 <= zext_ln89_fu_333_p1(3 - 1 downto 0);
    ...
    buf_3_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln91_reg_380_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln91_reg_380_pp0_iter1_reg = ap_const_lv3_3))) then 
    ...
    buf_4_address0 <= zext_ln89_fu_333_p1(3 - 1 downto 0);
    ...
    buf_4_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln91_reg_380_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln91_reg_380_pp0_iter1_reg = ap_const_lv3_4))) then 
    ...
    buf_5_address0 <= zext_ln89_fu_333_p1(3 - 1 downto 0);
    ...
    buf_5_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln91_reg_380_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln91_reg_380_pp0_iter1_reg = ap_const_lv3_5))) then 
    ...
    buf_6_address0 <= zext_ln89_fu_333_p1(3 - 1 downto 0);
    ...
    buf_6_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln91_reg_380_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln91_reg_380_pp0_iter1_reg = ap_const_lv3_6))) then 
    ...
    buf_7_address0 <= zext_ln89_fu_333_p1(3 - 1 downto 0);
    ...
    buf_7_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, trunc_ln91_reg_380_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (trunc_ln91_reg_380_pp0_iter1_reg = ap_const_lv3_7))) then 
    ...
    c_fu_279_p2 <= std_logic_vector(unsigned(select_ln86_fu_249_p3) + unsigned(ap_const_lv4_1));
    empty_fu_265_p1 <= r_fu_257_p3(3 - 1 downto 0);
    icmp_ln89_fu_291_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten2_load = ap_const_lv6_3F) else "0";
    icmp_ln91_fu_285_p2 <= "1" when (c_fu_279_p2 = ap_const_lv4_8) else "0";
    input_r_address0 <= zext_ln92_fu_328_p1(6 - 1 downto 0);
    ...
    r_fu_257_p3 <= 
        add_ln89_fu_243_p2 when (ap_phi_mux_icmp_ln915_phi_fu_212_p4(0) = '1') else 
        ap_sig_allocacmp_r3_load;
    select_ln86_fu_249_p3 <= 
        ap_const_lv4_0 when (ap_phi_mux_icmp_ln915_phi_fu_212_p4(0) = '1') else 
        ap_sig_allocacmp_c4_load;
    tmp_3_fu_312_p3 <= (empty_reg_375 & ap_const_lv3_0);
    trunc_ln91_fu_269_p1 <= select_ln86_fu_249_p3(3 - 1 downto 0);
    zext_ln89_fu_333_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(r_reg_370_pp0_iter1_reg),64));
    zext_ln91_fu_319_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln86_reg_365),6));
    zext_ln92_fu_328_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln92_fu_322_p2),64));
end behav;
