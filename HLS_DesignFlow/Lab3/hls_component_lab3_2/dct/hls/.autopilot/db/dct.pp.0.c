...
# 263 "/home/rimurutempest/Tool/Xilinx/Vitis/2024.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
DCT_Outer_Loop:
   for (k = 0; k < 8; k++) {
#line 19 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 39 "../source/dct.c"

DCT_Inner_Loop:
      for(n = 0, tmp = 0; n < 8; n++) {
#line 18 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 41 "../source/dct.c"
...
Xpose_Row_Outer_Loop:
   for (j = 0; j < 8; j++)
#line 20 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 64 "../source/dct.c"
...
Xpose_Row_Inner_Loop:
      for(i = 0; i < 8; i++)
#line 21 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 68 "../source/dct.c"
...
Col_DCT_Loop:
   for (i = 0; i < 8; i++) {
#line 22 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 72 "../source/dct.c"
...
Xpose_Col_Outer_Loop:
   for (j = 0; j < 8; j++)
#line 23 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 77 "../source/dct.c"

Xpose_Col_Inner_Loop:
      for(i = 0; i < 8; i++)
#line 24 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 79 "../source/dct.c"
...
RD_Loop_Row:
   for (r = 0; r < 8; r++) {
#line 25 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 88 "../source/dct.c"

RD_Loop_Col:
      for (c = 0; c < 8; c++)
#line 26 "/home/rimurutempest/Code/LSI_Design_Contest/HLS_DesignFlow/Lab3/hls_component_dct/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 90 "../source/dct.c"
